...
var vegetables = ['cabbage', 'carrot', 'spinach', 'pepper', 'kale'];
...
// different fruits.
var fruits = ['watermelon', 'melon', 'mango', 'guava', 'kiwi', 'banana', 'apple'];
...
var groceryStore = {name: 'King Soopers', isOpen: true, hours: 24};
